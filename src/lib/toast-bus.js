...
if (!W.__appToastBus) {
  W.__appToastBus = {
    show({ title, text = "", type = "info", id, duration = 2500 }) {
      ...
      W.dispatchEvent(new CustomEvent("app-toast", {
    ...
    confirm({ title = "Xác nhận", text = "", confirmText = "Đồng ý", cancelText = "Hủy", type = "warning" }) {
      return new Promise((resolve) => {
        ...
        W.dispatchEvent(new CustomEvent("app-confirm", {
